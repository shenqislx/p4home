...
代表性家庭数据、P4/Voice 端到端、家庭身份模型和 SQLite 真实断电、
quota/retention/加密/secure-delete 证据。6I APFS 权限、WAL/NORMAL、受控进程终止、
完整性/损坏拒绝、在线备份和 checkpoint 冷备份子门禁已本地通过，待 clean-commit 复跑。
...
当前真值且 `service_calls=0`，已从干净工作树复跑并绑定提交。6I 文件系统子门禁也已本地通过。见
